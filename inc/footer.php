        ...
        <div class="container py-5">
            <div class="row g-5">
                <div class="col-lg-3 col-md-6">
                    ...
                    <p class="mb-2"><i class="fa fa-map-marker-alt me-3" style="text-transform: uppercase;"></i>123 street , abc area , bhavnagar</p>
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <div class="position-relative mx-auto" style="width: 400px;">
                        <img src="images/logo4.png" style="width: 250px;" alt="">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="copyright">
                <div class="row">
                    <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                        &copy; <a class="border-bottom" href="#">Samaira Green Ship Recyclin</a>, All Right Reserved.
                    </div>
