...
?>
    ...
    <div class="container-fluid page-header py-5" style="margin-bottom: 2rem;">
        <div class="container py-5">
            <h1 class="display-3 text-white mb-3 animated slideInDown" style="text-transform:uppercase;">legal
                compliance</h1>
            ...
            <div class="row g-5 mx-lg-0">
                ...
                <div class="col-lg-6 pe-lg-0 wow fadeInRight" data-wow-delay="0.1s" style="min-height: 450px;">
                    <div class="position-relative h-100">
                        <img class="position-absolute img-fluid w-100 h-100 p-1" src="images/gasmeter.jpg"
                            style="object-fit: cover; border:2px solid black; border-radius:10px; margin-right:10px;" alt="">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container about py-5 px-lg-0">
            <div class="row g-5 mx-lg-0">
                <div class="col-lg-6 ps-lg-0 wow fadeInLeft" data-wow-delay="0.1s" style="min-height: 400px;">
                    <div class="position-relative h-100">
                        <img class="position-absolute img-fluid w-100 h-100 p-1" src="images/fire.jpg"
                            style="object-fit: cover; border:3px solid black; border-radius:10px; margin-left:10px; " alt="">
                    </div>
                </div>
    ...
    <div class="container-xxl py-5 wow fadeInUp" data-wow-delay="0.1s">
        <div class="container py-5">
            <div class="text-center">
                <h6 class="text-secondary text-uppercase">Legal pics</h6>
                <h1 class="mb-0">Oxygen Pics</h1>
            </div>
        ...
        <div class="container py-5">
            ...
            <div class="owl-carousel testimonial-carousel wow fadeInUp" data-wow-delay="0.1s">
                ...
                <div class="testimonial-item p-2 ">
                    <!-- <i class="fa fa-quote-right fa-3x text-light position-absolute top-0 end-0 mt-n3 "></i> -->
                    <div class="d-flex align-items-end mb-2">
                        <img class="img-fluid flex-shrink-0" src="images/lpg (4).jpg"
                            >
                    </div>
                </div>
                <div class="testimonial-item p-2 ">
                    <!-- <i class="fa fa-quote-right fa-3x text-light position-absolute top-0 end-0 mt-n3 "></i> -->
                    <div class="d-flex align-items-end mb-2">
                        <img class="img-fluid flex-shrink-0" src="images/lpg (5).jpg"
                            >
                    </div>
                </div>
            </div>
    ...
    <div class="container-xxl py-5 wow fadeInUp" data-wow-delay="0.1s">
        <div class="container py-5">
            <div class="text-center">
                <h6 class="text-secondary text-uppercase">Legal pics</h6>
                <h1 class="mb-0">Electricity panel pics</h1>
            </div>
            <div class="owl-carousel testimonial-carousel wow fadeInUp" data-wow-delay="0.1s">
                <div class="testimonial-item p-2 ">
                    <!-- <i class="fa fa-quote-right fa-3x text-light position-absolute top-0 end-0 mt-n3 "></i> -->
